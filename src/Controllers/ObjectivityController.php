...
class ObjectivityController {
    ...
    public function createReturnEnglishObjectivityPlaintext (
                $body) 
    {
     ...
     * @return mixed response from the API call*/
    public function createReturnEnglishObjectivityMultipartForm (
                $text) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::$BASEURI;
     ...
     * @return mixed response from the API call*/
    public function createReturnEnglishObjectivityEncodedForm (
                $text) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::$BASEURI;
